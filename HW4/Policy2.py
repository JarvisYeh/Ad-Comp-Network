...
def autoRouting():
    ...
    while True:
        ...
        h1toh5_byteCount_prev = 0
        h1toh5_byteCount_after = 0
        ...
        _, h1toh5_byteCount_prev, _ = mon.getStatics("00:00:00:00:00:00:00:03", "10.0.0.1", "10.0.0.5")
        ...
        _, h1toh5_byteCount_after, _ = mon.getStatics("00:00:00:00:00:00:00:03", "10.0.0.1", "10.0.0.5")   

        time = time_after - time_prev
        byteCount = h1toh3_byteCount_after - h1toh3_byteCount_prev + h1toh4_byteCount_after - h1toh4_byteCount_prev + h1toh5_byteCount_after - h1toh5_byteCount_prev
        ...
        print "h1 tp h5 throughput: ", (h1toh5_byteCount_after - h1toh5_byteCount_prev)*8.0/1000000, "Mbps"
        print "total tp: ", tp
...
def reroute():
    print 'switching to H1 -> S1 -> S2 -> S3 -> H4'
    print 'switching to H1 -> S1 -> S2 -> S3 -> H5'
